...
p2017 <- bv_communes_2017 |> 
    mapview(zcol = "type",
    layer.name = "Bureaux de votes aux éléctions de 2017",
    legend = TRUE, 
    col.regions = c("Bureau de vote" = "wheat1", "Commune" = "salmon"),
    popup = popupTable(bv_communes_2017, zcol = c("id")))
p2022 <- bv_communes_full_2022 |> 
    mapview(zcol = "new_bv",
    layer.name = "Bureaux de votes aux éléctions de 2022",
    legend = TRUE,
    col.regions = c("Bureaux de votes créés" = "brown3", "Bureaux de votes identiques" = "wheat2"),
    popup = popupTable(bv_communes_full_2022, zcol = c("id_2022"))) 
sync(p2017,p2022)
p2017 | p2022
```
