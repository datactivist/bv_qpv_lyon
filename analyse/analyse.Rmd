...
qpv69_pres_17_t1 <- tidycensus::interpolate_pw(from = bv_grandyon_p2017_t1_res, to = qpv_gd_lyon, to_id = "CODE_QP", extensive = TRUE, weights = poids_2017, weight_column = "n")
